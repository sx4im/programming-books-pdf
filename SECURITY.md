...
Please **do not** open a public issue that repeats a malicious URL if that would amplify harm.
...
Broken, redirected, or outdated (but non-malicious) links should use the [broken link issue template](.github/ISSUE_TEMPLATE/broken-link.yml).
